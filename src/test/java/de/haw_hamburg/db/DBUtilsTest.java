...
public class DBUtilsTest {
	...
	public void setUp() throws Exception {
		...
		AccountType account1=DBUtils.createAccountType("Ash", "clatu...", "cabinInTheWoods", 666);
		AccountType account2=DBUtils.createAccountType("OneHandedAsh", "clatu...", "fancyCastle", 666);
	...
	@Test
	public void testGetAllMessages() throws FileNotFoundException, JAXBException {
